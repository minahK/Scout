            ...
            <div class="sidebar-profile">
                <c:choose>
                    <c:when test="${not empty loginUser}">
                        <img src="/upload/${loginUser.profileImage}" alt="프로필 이미지" />
                        <div>
            ...
            <c:choose>
                <c:when test="${not empty keyword}">
                    ...
                    <c:forEach var="post" items="${posts}">
                        <div class="post-box">
                            <div class="post-info">
                                <img src="/upload/${post.profileImage}" alt="프로필 이미지" />
                                <div>
                        ...
                        <c:forEach var="user" items="${recommendedUsers}">
                            <li>
                                <div class="follow-info">
                                    <img src="/upload/${user.profileImage}" alt="프로필 이미지" />
                                    <div>
