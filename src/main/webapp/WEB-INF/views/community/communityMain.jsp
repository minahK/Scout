...
<div class="layout">
            ...
            <div class="sidebar-profile">
                <c:choose>
                    <c:when test="${not empty loginUser}">
                        <img src="/image/community/${loginUser.profileImage}" />
                        <div>
                    ...
                    <c:otherwise>
                        <img src="/image/community/default-profile.png" alt="기본 이미지" />
                        <div>
    ...
    <main class="main">
        ...
        <form class="post-form" action="/community/post" method="post" enctype="multipart/form-data">
            <img class="profile" src="/image/community/${empty loginUser.profileImage ? 'default-profile.png' : loginUser.profileImage}" alt="프로필" />
            <div style="flex: 1;">
        ...
        <c:forEach var="post" items="${posts}">
            <div class="post-box">
                <div style="display: flex; align-items: center; gap: 10px;">
                    <img src="/image/community/${empty post.profileImage ? 'default-profile.png' : post.profileImage}" width="40" height="40" style="border-radius: 50%;" />
                    <div>
                ...
                <c:forEach var="user" items="${recommendedUsers}">
                    <div class="follow-item">
                        <div class="follow-left">
                            <img src="/image/community/${empty user.profileImage ? 'default-profile.png' : user.profileImage}" alt="profile"/>
                            <div>
        ...
        document.querySelectorAll('.comment-icon').forEach(icon => {
            icon.addEventListener('click', function () {
                ...
                if (form.style.display === 'none' || form.style.display === '') {
                    form.style.display = 'flex'; // 'flex'로 변경하여 버튼과 입력창이 한 줄에 오도록 함
                } else {
