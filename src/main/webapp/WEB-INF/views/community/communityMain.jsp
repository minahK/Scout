		...
		<div class="sidebar">
			<div>
				<div class="sidebar-logo">
					<a href="/"> <img src="https://i.imgur.com/xpGazxz.png"
						alt="Logo" />
					</a>
				</div>
				<ul>
				...
				<div style="flex: 1;">
					...
					<div class="post-options">
						<button type="button" class="option-btn" data-type="image"
							title="이미지 첨부">📷</button>
						<button type="button" class="option-btn" data-type="video"
							title="비디오 첨부">🎥</button>
						<button type="button" class="option-btn" data-type="location"
							title="위치 태그">📍</button>
					</div>
