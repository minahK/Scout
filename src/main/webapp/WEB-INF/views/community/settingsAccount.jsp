	...
	<div class="layout">
		...
		<main class="main">
			<div class="card">
				...
				<form method="post" action="${ctx}/community/settings/account"
					...
					<div class="row">
						...
						<div class="preview">
							<img id="avatarPreview"
								src="${ctx}/image/community/default-profile.png" alt=""> <label
								class="btn btn-outline"> 이미지 선택 <input type="file"
								name="profileImageFile" accept="image/*" style="display: none">
							</label>
						</div>
					</div>
					...
					<div class="row">
						<label for="nickname">닉네임</label> <input id="nickname"
							...
							value="<c:out value='${nickname}' default=''/>">
					</div>

					<div class="row">
						<label for="handle">핸들</label> <input id="handle" name="handle"
							class="input" maxlength="30"
							value="<c:out value='${handle}' default=''/>">
					...
					<div class="row">
						<label for="email">이메일</label> <input id="email" type="email"
							name="email" class="input" maxlength="120"
				...
				<form method="post"
					action="${ctx}/community/settings/account/password">
					<div class="row">
					...
					<div class="row">
						<label for="newPassword">새 비밀번호</label> <input id="newPassword"
							name="newPassword" type="password" class="input" minlength="6"
							required>
					</div>
					<div class="row">
						<label for="newPasswordConfirm">새 비밀번호 확인</label> <input
							id="newPasswordConfirm" name="newPasswordConfirm" type="password"
